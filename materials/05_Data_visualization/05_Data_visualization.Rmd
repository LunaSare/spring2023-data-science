...
4. Reproduce the Figure 1 a and b from the Böhm et al., 2017 paper. 

5. Reproduce Figure 1d. hint: you can use either the `cut` or `findInterval()` functions

6. Reproduce Figures 2a-c using the basic graphic functions in R and ggplot

7. Divide the number of ecoregions into two categorical levels "Specialists" and "Generalists"

8. Reproduce Figure 4 adjusting the colour by the new categorical variable of the number of ecoregions.
